...
def change_and_enable_apn():
    subprocess.call('adb shell rdb set link.profile.1.apn apn1', shell=True)
    time.sleep(1)
    ...
    subprocess.call('adb shell rdb set link.profile.2.apn apn2', shell=True)
    time.sleep(1)
    ...
    subprocess.call('adb shell rdb set link.profile.1.apn apn3', shell=True)
    subprocess.call('adb shell rdb set link.profile.1.writeflag 1', shell=True)
    time.sleep(1)
...
if option == '1':
    ...
    print("**WARNING**")
    print("This will set APN1=apn1_name. Press Enter to continue or Press Q to quit")
